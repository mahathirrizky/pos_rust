...
import { useStoreManagerPromotionStore } from '../../store/storeManagerPromotion';

const confirm = useConfirm();
const toast = useToast();
const promotionStore = useStoreManagerPromotionStore();
    ...
    <Card>
      <template #title>
        <div class="flex justify-between items-center">
          <span class="text-2xl font-semibold">Promotion Management</span>
        </div>
      </template>
      <template #content>
        <Toolbar class="mb-4">
